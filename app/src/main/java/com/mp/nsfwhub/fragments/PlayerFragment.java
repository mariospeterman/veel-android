...
import com.mp.nsfwhub.activities.MainActivity;
import com.mp.nsfwhub.common.VisibilityAware;
import com.mp.nsfwhub.data.ClipDataSource;
import com.mp.nsfwhub.data.api.REST;
import com.mp.nsfwhub.data.models.Clip;
import com.mp.nsfwhub.data.models.User;
import com.mp.nsfwhub.events.PlaybackEndedEvent;
import com.mp.nsfwhub.events.RecordingOptionsEvent;
import com.mp.nsfwhub.events.ResetPlayerSliderEvent;
import com.mp.nsfwhub.events.ResolveRecordingOptionsEvent;
import com.mp.nsfwhub.particles.SpinnerParticleSystem;
import com.mp.nsfwhub.particles.SpinnerTextureAtlasFactory;
import com.mp.nsfwhub.utils.AnimationUtil;
import com.mp.nsfwhub.utils.SizeUtil;
import com.mp.nsfwhub.utils.SocialSpanUtil;
import com.mp.nsfwhub.utils.TempUtil;
import com.mp.nsfwhub.utils.TextFormatUtil;
import com.mp.nsfwhub.utils.VideoUtil;
import com.mp.nsfwhub.workers.SaveToGalleryWorker;
...
public class PlayerFragment extends Fragment implements AnalyticsListener, VisibilityAware, SocialSpanUtil.OnSocialLinkClickListener {
    ...
    private void recordView() {
        ...
        if (mModel2.isLoggedIn()) {
            Prefs.putInt("completeVideos", Prefs.getInt("completeVideos", 0) + 1);
            mModel2.videoCount.postValue(Prefs.getInt("completeVideos", 0));
        }
        REST rest = MainApplication.getContainer().get(REST.class);
