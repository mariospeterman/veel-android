...
import com.mp.nsfwhub.activities.PaymentActivity;
import com.mp.nsfwhub.common.DiffUtilCallback;
import com.mp.nsfwhub.common.LoadingState;
import com.mp.nsfwhub.data.CreditDataSource;
...
public class WalletFragment extends Fragment implements PurchasesUpdatedListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mModel2.wallet.postValue(Prefs.getInt("wallet", 0));
        if (MainActivity.mBuilder.isShowing()) {
            MainActivity.mBuilder.dismiss();
        }
        ...
        MainActivity.showDiialog = false;
        MainActivity.mBuilder.dismiss();
    }
                ...
                .enqueue(new Callback<Wrappers.Single<Balance>>() {
                    ...
                    public void onResponse(
                        ...
                        if (isAdded()) {
                            ...
                            mModel2.wallet.postValue(balance);
                            Prefs.putInt("wallet", balance);
