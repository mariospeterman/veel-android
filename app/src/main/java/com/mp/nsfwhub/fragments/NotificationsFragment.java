...
import com.mp.nsfwhub.data.NotificationDataSource;
...
public class NotificationsFragment extends Fragment {
    ...
    private class NotificationAdapter extends PagedListAdapter<Notification, NotificationViewHolder> {
        ...
        public void onBindViewHolder(@NonNull NotificationViewHolder holder, int position) {
            ...
            else if (TextUtils.equals(notification.type, "send_gift")) {
                holder.content.setText(getString(R.string.notification_send_gift, username));
            } else if (TextUtils.equals(notification.type, "sent_you_message")) {
                holder.content.setText(getString(R.string.notification_sent_you_message, username));
