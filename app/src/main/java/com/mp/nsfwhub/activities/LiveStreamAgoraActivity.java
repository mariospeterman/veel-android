...
import com.mp.nsfwhub.agora.DefaultRtmChannelListener;
import com.mp.nsfwhub.agora.DefaultRtmClientListener;
...
public class LiveStreamAgoraActivity extends LiveStreamBaseActivity {
    ...
    protected LiveStreamAgoraActivityViewModel mModel2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mModel2 = new ViewModelProvider(this).get(LiveStreamAgoraActivityViewModel.class);
    }
    ...
    private void setupRtcEngine(
        ...
        findViewById(R.id.flip).setOnClickListener(v -> mRtcEngine.switchCamera());
        findViewById(R.id.flash)
                .setOnClickListener(v -> {
                    if (mRtcEngine.isCameraTorchSupported()) {
                        mRtcEngine.setCameraTorchOn(mModel2.torch = !mModel2.torch);
                    }
                });
        View view = findViewById(R.id.left);
        view.setVisibility(publisher ? View.VISIBLE : View.GONE);
        if (user != null) {
    ...
    public static class LiveStreamAgoraActivityViewModel extends ViewModel {
