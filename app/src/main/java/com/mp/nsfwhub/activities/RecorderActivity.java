...
import com.mp.nsfwhub.common.FilterAdapter;
import com.mp.nsfwhub.common.VideoFilter;
import com.mp.nsfwhub.data.models.Song;
import com.mp.nsfwhub.data.models.Sticker;
import com.mp.nsfwhub.filters.ExposureFilter;
import com.mp.nsfwhub.filters.HazeFilter;
import com.mp.nsfwhub.filters.MonochromeFilter;
import com.mp.nsfwhub.filters.PixelatedFilter;
import com.mp.nsfwhub.filters.SolarizeFilter;
import com.mp.nsfwhub.utils.AnimationUtil;
import com.mp.nsfwhub.utils.BitmapUtil;
import com.mp.nsfwhub.utils.IntentUtil;
import com.mp.nsfwhub.utils.LocaleUtil;
import com.mp.nsfwhub.utils.TempUtil;
import com.mp.nsfwhub.utils.TextFormatUtil;
import com.mp.nsfwhub.utils.VideoUtil;
import com.mp.nsfwhub.workers.MergeAudioVideoWorker2;
import com.mp.nsfwhub.workers.MergeVideosWorker2;
import com.mp.nsfwhub.workers.VideoSpeedWorker2;
...
public class RecorderActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == SharedConstants.REQUEST_CODE_PICK_VIDEO && resultCode == RESULT_OK && data != null) {
            ...
            File copy = TempUtil.createCopy(this, data.getData(), ".mp4");
            copy.getParentFile().getAbsolutePath();

            MediaPlayer mp = MediaPlayer.create(RecorderActivity.this, data.getData());
            int duration = mp.getDuration();
            mp.release();
            if (duration > SharedConstants.MAX_DURATION){
                Toast.makeText(RecorderActivity.this, "Maximum " +SharedConstants.MAX_DURATION/1000 + " second video can upload", Toast.LENGTH_SHORT).show();
            }else {
...
//                  .setCompressOption(new CompressOption()) //pass empty constructor for default compress option
                    .setDestination(RecorderActivity.this.getCacheDir().getAbsolutePath())
    ...
    private void proceedToFilter(File file) {
        Intent intent;
        if (getResources().getBoolean(com.mp.nsfwhub.R.bool.filters_enabled)) {
            intent = new Intent(this, FilterActivity.class);
