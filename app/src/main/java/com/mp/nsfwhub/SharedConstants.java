...
final public class SharedConstants {
    ...
    public static final long MAX_DURATION = TimeUnit.SECONDS.toMillis(123);
     ...
     */
    public static final int MAX_VIDEO_RESOLUTION = 1920 /* pixels */;
    ...
    public static final int VIDEO_BITRATE = 2400 /* kbps */ * 1200;
